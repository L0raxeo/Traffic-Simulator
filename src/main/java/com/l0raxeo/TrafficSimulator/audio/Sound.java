package com.l0raxeo.TrafficSimulator.audio;
...
public class Sound
{
    ...
    public Sound(String filepath, boolean loops)
    {
        ...
        // Retrieve the extra information that was stored in the buffers byy stb
    ...
    /**
     * Deletes resource from runtime/memory
     * NOT THE SAME AS STOPPING IT FROM PLAYING
     */
    public void delete()
    {
    ...
    /**
     * Stops the playing of the file without deleting it
     */
    public void stop()
    {
        if (isPlaying)
