package com.l0raxeo.TrafficSimulator.input;
...
public class MouseListener
{
    ...
    public static Vector2f screenToWorld(Vector2f screenCoords) {
        Vector2f normalizedScreenCords = new Vector2f(
                ...
                (Window.getHeight() - screenCoords.y) / Window.getHeight()
        );
        normalizedScreenCords.mul(2.0f).sub(new Vector2f(1.0f, 1.0f));
        Camera camera = Window.getSimulator().camera();
    ...
    public static float getOrthoX()
    {
        ...
        tmp.mul(Window.getSimulator().camera().getInverseProjection()).mul(Window.getSimulator().camera().getInverseView());
        currentX = tmp.x;
