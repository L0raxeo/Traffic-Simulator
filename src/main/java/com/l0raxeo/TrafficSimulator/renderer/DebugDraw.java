...
import com.l0raxeo.TrafficSimulator.utils.AssetPool;
...
public class DebugDraw
{
    ...
    public static void draw() {
        ...
        // Use our shader
        shader.use();
        shader.uploadMat4f("uProjection", Window.getSimulator().camera().getProjectionMatrix());
        shader.uploadMat4f("uView", Window.getSimulator().camera().getViewMatrix());
